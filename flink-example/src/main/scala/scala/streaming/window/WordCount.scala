package scala.streaming.window
...
/**
  * ./bin/flink run -m yarn-cluster -ys 3 -p 3 -yjm 1024 -ytm 2048 -ynm FlinkStreamingWindowWordCount -yqu root.work -c scala.streaming.window.WordCount ck_test/flink-example-1.0-SNAPSHOT.jar --input-topic words --bootstrap.servers localhost:9092 --zookeeper.connect localhost:2181 --group.id ck
  * */
object WordCount {
