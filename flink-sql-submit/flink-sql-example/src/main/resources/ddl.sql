...
GRANT ALL PRIVILEGES ON flink_test.* TO 'root'@'hadoop-01' IDENTIFIED BY 'root';
GRANT ALL PRIVILEGES ON flink_test.* TO 'root'@'hadoop-02' IDENTIFIED BY 'root';
GRANT ALL PRIVILEGES ON flink_test.* TO 'root'@'hadoop-03' IDENTIFIED BY 'root';
flush privileges;
