...
function create_kafka_topic {
    $KAFKA_DIR/bin/kafka-topics.sh --create --zookeeper $ZOOKEEPER_CONNECT --replication-factor $1 --partitions $2 --topic $3
}

function drop_kafka_topic {
    $KAFKA_DIR/bin/kafka-topics.sh --delete --zookeeper $ZOOKEEPER_CONNECT --topic $1
}
